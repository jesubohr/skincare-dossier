...
export default function DashboardSettingsPage() {
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Loading practice settings</p>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight text-foreground">Settings</h1>
        <p className="mt-1 text-sm text-muted-foreground">Practice hours and calendar capacity</p>
      </div>
      ...
      <Card className="max-w-3xl gap-0 py-0 shadow-none">
        <CardContent className="p-5">
          <div className="mb-5 flex items-center gap-2">
            ...
            <h2 className="font-semibold text-foreground">Practice Hours</h2>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="dailyCapacityMinutes">Daily capacity</Label>
