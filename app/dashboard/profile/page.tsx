...
export default function ProfilePage() {
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Loading practitioner profile</p>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight text-foreground">Profile</h1>
        <p className="mt-1 text-sm text-muted-foreground">Clinical identity and practitioner details</p>
      </div>
        ...
        <Card className="gap-0 py-0 shadow-none">
          <CardContent className="p-5">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-1 text-sm text-muted-foreground">{profile.professionalTitle ?? "Practitioner"}</p>
            ...
            <div className="mt-6 space-y-2">
              ...
              <p className="text-xs text-muted-foreground">{uploading ? "Uploading image..." : "Upload a clear professional image for your profile."}</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="gap-0 py-0 shadow-none">
          <CardContent className="p-5">
            <div className="mb-5 flex items-center gap-2">
              ...
              <h2 className="font-semibold text-foreground">Clinical Profile</h2>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="professionalTitle" name="professionalTitle" defaultValue={profile.professionalTitle ?? ""} placeholder="Licensed esthetician" />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="specialties" value={specialties} onChange={(event) => setSpecialties(event.target.value)} placeholder="HydraFacial, peels, post-treatment care" />
              </div>

              <div className="space-y-2">
                <Label htmlFor="bio">Bio</Label>
                <Textarea id="bio" name="bio" rows={5} defaultValue={profile.bio ?? ""} placeholder="Short professional profile for internal records and client-facing contexts." />
              </div>
