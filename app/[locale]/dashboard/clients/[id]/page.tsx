        ...
        <div className="space-y-6 mt-20">
          <div className="flex items-center justify-between ml-17">
            <div className="space-y-1">
              <h2 className="text-2xl font-bold tracking-tight text-foreground">{t("history")}</h2>
          ...
          <div className="relative space-y-8 pl-4">
                    ...
                    <div className="flex items-center justify-between bg-card p-4 px-6">
                      {entry.nextVisit && (
                        <div className="flex items-center gap-2 rounded-md bg-muted px-3 py-1.5 text-sm font-medium text-primary">
                          ...
                          {t("nextVisit", { date: entry.nextVisit })}
                        </div>
                      )}
            ...
            {(!client.treatmentHistory || client.treatmentHistory.length === 0) && <div className="text-center py-12 text-muted-foreground">{t("emptyHistory")}</div>}
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="flex gap-6">
          ...
          <div className="space-y-2 pt-1">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span className="font-medium text-foreground/70">{t("yearsOld", { age: calculateAge(client.birthDate) })}</span>
              <span>-</span>
              <span>{t("skinType", { type: client.skinType || common("notSpecified") })}</span>
            </div>
